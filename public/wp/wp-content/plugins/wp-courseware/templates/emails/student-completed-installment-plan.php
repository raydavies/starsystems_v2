<?php
/**
 * Email - Student - Cancelled Installment Plan
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/student-cancelled-installment-plan.php.
 *
 * @package WPCW
