<?php
/**
 * Email - Student - Completed Installment Order
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/student-completed-installment-order.php.
 *
 * @package WPCW
