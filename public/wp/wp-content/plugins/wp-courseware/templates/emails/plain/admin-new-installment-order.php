<?php
/**
 * Plain Text Email - Admin - New Installment Order
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/admin-new-installment-order.php
 *
 * @package WPCW
