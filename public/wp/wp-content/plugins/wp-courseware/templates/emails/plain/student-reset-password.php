<?php
/**
 * Plain Text Email - Student - Reset Password
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/student-reset-password.php
 *
 * @package WPCW
