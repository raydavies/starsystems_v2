<?php
/**
 * Plain Text Email - Admin - Expired Subscription
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/admin-expired-subscription.php
 *
 * @package WPCW
