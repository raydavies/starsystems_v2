<?php
/**
 * Plain Text Email - Student - Completed Installment Order
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/student-completed-installment-order.php
 *
 * @package WPCW
