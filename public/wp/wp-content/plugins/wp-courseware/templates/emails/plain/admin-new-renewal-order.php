<?php
/**
 * Plain Text Email - Admin - New Renewal Order
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/admin-new-renewal-order.php
 *
 * @package WPCW
