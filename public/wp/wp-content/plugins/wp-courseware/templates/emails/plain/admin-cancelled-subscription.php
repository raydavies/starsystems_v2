<?php
/**
 * Plain Text Email - Admin - Cancelled Subscription
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/admin-cancelled-subscription.php
 *
 * @package WPCW
