<?php
/**
 * Plain Text Email - Student - Completed Order
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/student-completed-order.php
 *
 * @package WPCW
