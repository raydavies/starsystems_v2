<?php
/**
 * WP Courseware Quiz Random Selection Question Type.
 *
 * @package WPCW
 * @since 1.0.0
 */

if ( ! class_exists( 'WPCW_quiz_RandomSelection' ) ) {
	/**
	 * Class WPCW_quiz_RandomSelection.
	 *
	 * The class that represents a question where
	 * questions are selected from several tags.
	 *
	 * @since 1.0.0
	 */
	class WPCW_quiz_RandomSelection extends WPCW_quiz_base {
		 ...
		 */
		public static function decodeTagSelection( $dataToDecode ) {
