<?php
/**
 * Gradebook Send Email Vue Template.
 *
 * @note See page-user-progress.php for inclusion.
 *
 * @since 4.1.0
 */
?>
<script type="text/x-template" id="wpcw-gradebook-send-email">
    <div id="wpcw-gradebook-send-email-modal" class="wpcw-gradebook-send-email-modal wpcw-modal wpcw-mfp-hide">
