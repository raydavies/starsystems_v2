...
/*-----------------------------------------------------------------------------------------------------//
	sensiblewp Widget Columns
-------------------------------------------------------------------------------------------------------*/
	
function sensiblewp_widget_columns() {
	
	 			$widget_columns = get_theme_mod( 'sensiblewp_widget_columns' ); 
...
add_action( 'wp_enqueue_scripts', 'sensiblewp_widget_columns' ); 
