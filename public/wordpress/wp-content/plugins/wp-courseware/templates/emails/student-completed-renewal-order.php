<?php
/**
 * Email - Student - Completed Renewal Order
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/student-completed-renewal-order.php.
 *
 * @package WPCW
