<?php
/**
 * Plain Text Email - Student - Completed Renewal Order
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/student-completed-renewal-order.php
 *
 * @package WPCW
