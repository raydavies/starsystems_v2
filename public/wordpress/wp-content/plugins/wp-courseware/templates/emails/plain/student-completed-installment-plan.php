<?php
/**
 * Plain Text Email - Student - Completed Installment Plan
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/plain/student-complted-installment-plan.php
 *
 * @package WPCW
