<?php
/**
 * Email - Admin - Cancelled Installment Plan
 *
 * This template can be overridden by copying it to yourtheme/wp-courseware/emails/admin-cancelled-installment-plan.php.
 *
 * @package WPCW
