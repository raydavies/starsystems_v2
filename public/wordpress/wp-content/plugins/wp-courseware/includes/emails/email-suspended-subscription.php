<?php
/**
 * WP Courseware Email - Suspended Subscription
 *
 * @package WPCW
 * @subpackage Emails
 * @since 4.3.0
...
/**
 * Class Email_Suspended_Subscription.
 *
 * @since 4.3.0
 */
class Email_Suspended_Subscription extends Email {
	...
	public function __construct() {
		$this->id             = 'email_suspended_subscription';
		$this->title          = esc_html__( 'Suspended Subscription', 'wp-courseware' );
		$this->description    = esc_html__( 'Suspended subscription emails are sent to chosen recipient(s) when a students subscription is suspended (either by the administrator or student).', 'wp-courseware' );
		$this->template_html  = 'emails/admin-suspended-subscription.php';
		$this->template_plain = 'emails/plain/admin-suspended-subscription.php';
	...
	public function get_default_subject() {
		return esc_html__( '[{site_title}] Subscription Suspended', 'wp-courseware' );
	}
	...
	public function get_default_heading() {
		return esc_html__( 'Subscription Suspended', 'wp-courseware' );
	}
	...
	public function get_default_content_html() {
		...
		<p>A subscription has been suspended. Below are the details:</p>
	...
	public function get_default_content_plain() {
		$plain_text = "Hello,\r\n";
		$plain_text .= "A subscription has been suspended. Below are the details:\r\n";
	...
	public function get_merge_tags() {
		...
		$suspended_subscription_merge_tags = array(
		...
		$merge_tags = array_merge( $merge_tags, $suspended_subscription_merge_tags );

		return apply_filters( 'wpcw_email_suspended_subscription_merge_tags', $merge_tags );
	}
