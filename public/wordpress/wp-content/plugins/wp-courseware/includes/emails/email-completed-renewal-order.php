<?php
/**
 * WP Courseware Email - Completed Renewal Order.
 *
 * @package WPCW
 * @subpackage Emails
 * @since 4.3.0
...
/**
 * Class Email_Completed_Renewal_Order.
 *
 * @since 4.3.0
 */
class Email_Completed_Renewal_Order extends Email {
	...
	public function __construct() {
		$this->id             = 'email_completed_renewal_order';
		$this->student_email  = true;
		$this->title          = esc_html__( 'Completed Renewal Order', 'wp-courseware' );
		$this->description    = esc_html__( 'Order complete emails are sent to customers when a subscription renewal order has been completed and payment has been received.', 'wp-courseware' );
		$this->template_html  = 'emails/student-completed-renewal-order.php';
		$this->template_plain = 'emails/plain/student-completed-renewal-order.php';

		parent::__construct();
	}

	/**
	 * Load Completed Renewal Order Email.
	 *
	 * @since 4.3.0
	 */
	...
	public function get_default_subject() {
		return esc_html__( 'Your {site_title} renewal order from {order_date} is complete', 'wp-courseware' );
	}
	...
	public function get_default_heading() {
		return esc_html__( 'Renewal Order Complete', 'wp-courseware' );
	}
	...
	public function get_default_content_html() {
		...
		<p>Your renewal order at <strong>{site_title}</strong> has been completed. Below are the details of your order:</p>
	...
	/**
	 * Get Completed Renewal Order Merge Tags.
	 *
	 * @since 4.3.0
	 *
	...
	public function get_merge_tags() {
		...
		return apply_filters( 'wpcw_email_completed_renewal_order_merge_tags', $merge_tags );
	}

	/**
	 * Trigger Email Completed Renewal Order.
	 *
	 * @since 4.3.0
	 *
