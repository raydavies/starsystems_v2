...
<body style="background-image: url({{ asset('img/bg/sky3.jpg') }})">
	<div style="padding: 15px; margin: 0 auto;">
		<img style="display: block;" src="{{ asset('img/starlogo-small.png') }}" />
		<div style="background-color: #fff; border-radius: 7px; margin: 10px; padding: 5px 15px 15px; display: inline-block;">
			...
			<p>
				<a href="{{ route('admin.customer', ['customer' => $customer->id]) }}" target="_blank">Click here to manage this customer in the Admin CRM</a>
			</p>
		</div>
	</div>
</body>
